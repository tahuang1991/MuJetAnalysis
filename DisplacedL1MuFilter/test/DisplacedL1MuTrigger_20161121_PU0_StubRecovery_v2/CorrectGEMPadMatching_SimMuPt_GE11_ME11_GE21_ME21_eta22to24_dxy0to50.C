...
//=========  (Mon Nov 21 17:09:12 2016) by ROOT version5.34/07
   ...
   den_clone47->SetTotalEvents(2,2);
   den_clone47->SetPassedEvents(2,2);
   den_clone47->SetTotalEvents(3,6);
   den_clone47->SetPassedEvents(3,6);
   den_clone47->SetTotalEvents(4,3);
   den_clone47->SetPassedEvents(4,3);
   den_clone47->SetTotalEvents(5,3);
   den_clone47->SetPassedEvents(5,3);
   den_clone47->SetTotalEvents(6,0);
   den_clone47->SetPassedEvents(6,0);
   den_clone47->SetTotalEvents(7,2);
   den_clone47->SetPassedEvents(7,2);
   den_clone47->SetTotalEvents(8,4);
   den_clone47->SetPassedEvents(8,4);
   den_clone47->SetTotalEvents(9,0);
   den_clone47->SetPassedEvents(9,0);
   den_clone47->SetTotalEvents(10,2);
   ...
   den_clone48->SetTotalEvents(2,2);
   den_clone48->SetPassedEvents(2,2);
   den_clone48->SetTotalEvents(3,10);
   den_clone48->SetPassedEvents(3,10);
   den_clone48->SetTotalEvents(4,7);
   den_clone48->SetPassedEvents(4,7);
   den_clone48->SetTotalEvents(5,3);
   den_clone48->SetPassedEvents(5,3);
   den_clone48->SetTotalEvents(6,6);
   den_clone48->SetPassedEvents(6,6);
   den_clone48->SetTotalEvents(7,4);
   den_clone48->SetPassedEvents(7,4);
   den_clone48->SetTotalEvents(8,9);
   den_clone48->SetPassedEvents(8,7);
   den_clone48->SetTotalEvents(9,6);
   den_clone48->SetPassedEvents(9,6);
   den_clone48->SetTotalEvents(10,2);
   den_clone48->SetPassedEvents(10,2);
   den_clone48->SetTotalEvents(11,13);
   den_clone48->SetPassedEvents(11,13);
   den_clone48->SetTotalEvents(12,8);
   den_clone48->SetPassedEvents(12,8);
   den_clone48->SetTotalEvents(13,11);
   den_clone48->SetPassedEvents(13,11);
   den_clone48->SetTotalEvents(14,4);
