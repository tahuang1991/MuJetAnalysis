...
//=========  (Tue Jan 31 10:18:21 2017) by ROOT version5.34/07
   ...
   den_clone9->SetPassedEvents(2,32);
   den_clone9->SetTotalEvents(3,294);
   den_clone9->SetPassedEvents(3,252);
   den_clone9->SetTotalEvents(4,478);
   den_clone9->SetPassedEvents(4,421);
   den_clone9->SetTotalEvents(5,582);
   den_clone9->SetPassedEvents(5,517);
   den_clone9->SetTotalEvents(6,667);
   den_clone9->SetPassedEvents(6,615);
   den_clone9->SetTotalEvents(7,665);
   den_clone9->SetPassedEvents(7,623);
   den_clone9->SetTotalEvents(8,748);
   den_clone9->SetPassedEvents(8,706);
   den_clone9->SetTotalEvents(9,789);
   den_clone9->SetPassedEvents(9,749);
   den_clone9->SetTotalEvents(10,766);
   den_clone9->SetPassedEvents(10,738);
   den_clone9->SetTotalEvents(11,1411);
   den_clone9->SetPassedEvents(11,1351);
   den_clone9->SetTotalEvents(12,1279);
   den_clone9->SetPassedEvents(12,1235);
   den_clone9->SetTotalEvents(13,1076);
   den_clone9->SetPassedEvents(13,1032);
   den_clone9->SetTotalEvents(14,886);
   den_clone9->SetPassedEvents(14,855);
   den_clone9->SetTotalEvents(15,765);
   den_clone9->SetPassedEvents(15,730);
   den_clone9->SetTotalEvents(16,1237);
   den_clone9->SetPassedEvents(16,1181);
   den_clone9->SetTotalEvents(17,785);
   den_clone9->SetPassedEvents(17,750);
   den_clone9->SetTotalEvents(18,541);
   den_clone9->SetPassedEvents(18,525);
   den_clone9->SetTotalEvents(19,372);
   den_clone9->SetPassedEvents(19,364);
   den_clone9->SetTotalEvents(20,260);
   den_clone9->SetPassedEvents(20,254);
   den_clone9->SetTotalEvents(21,110);
   den_clone9->SetPassedEvents(21,107);
   den_clone9->SetTotalEvents(22,42);
   den_clone9->SetPassedEvents(22,41);
   ...
   den_clone10->SetPassedEvents(3,57);
   den_clone10->SetTotalEvents(4,104);
   den_clone10->SetPassedEvents(4,91);
   den_clone10->SetTotalEvents(5,122);
   den_clone10->SetPassedEvents(5,101);
   den_clone10->SetTotalEvents(6,145);
   den_clone10->SetPassedEvents(6,128);
   den_clone10->SetTotalEvents(7,171);
   den_clone10->SetPassedEvents(7,161);
   den_clone10->SetTotalEvents(8,169);
   den_clone10->SetPassedEvents(8,145);
   den_clone10->SetTotalEvents(9,165);
   den_clone10->SetPassedEvents(9,153);
   den_clone10->SetTotalEvents(10,163);
   den_clone10->SetPassedEvents(10,144);
   den_clone10->SetTotalEvents(11,304);
   den_clone10->SetPassedEvents(11,273);
   den_clone10->SetTotalEvents(12,253);
   den_clone10->SetPassedEvents(12,233);
   den_clone10->SetTotalEvents(13,214);
   den_clone10->SetPassedEvents(13,194);
   den_clone10->SetTotalEvents(14,194);
   den_clone10->SetPassedEvents(14,175);
   den_clone10->SetTotalEvents(15,147);
   den_clone10->SetPassedEvents(15,137);
   den_clone10->SetTotalEvents(16,216);
   den_clone10->SetPassedEvents(16,196);
   den_clone10->SetTotalEvents(17,112);
   den_clone10->SetPassedEvents(17,97);
   den_clone10->SetTotalEvents(18,57);
   den_clone10->SetPassedEvents(18,55);
   den_clone10->SetTotalEvents(19,39);
   den_clone10->SetPassedEvents(19,37);
   den_clone10->SetTotalEvents(20,22);
   den_clone10->SetPassedEvents(20,21);
   den_clone10->SetTotalEvents(21,13);
   den_clone10->SetPassedEvents(21,12);
