...
//=========  (Thu Oct 27 15:31:25 2016) by ROOT version5.34/07
   ...
   htemp__31->SetBinContent(3,1446);
   htemp__31->SetBinContent(4,1152);
   htemp__31->SetBinContent(5,933);
   htemp__31->SetBinContent(6,732);
   htemp__31->SetBinContent(7,522);
   htemp__31->SetBinContent(8,324);
   htemp__31->SetBinContent(9,192);
   htemp__31->SetBinContent(10,138);
   ...
   htemp__31->SetBinError(3,65.8635);
   htemp__31->SetBinError(4,58.78775);
   htemp__31->SetBinError(5,52.90558);
   htemp__31->SetBinError(6,46.8615);
   htemp__31->SetBinError(7,39.57272);
   htemp__31->SetBinError(8,31.17691);
   htemp__31->SetBinError(9,24);
   htemp__31->SetBinError(10,20.34699);
