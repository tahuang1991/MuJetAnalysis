...
//=========  (Wed Nov  2 00:38:46 2016) by ROOT version5.34/07
   ...
   htemp->SetBinContent(1,2328.501);
   htemp->SetBinContent(2,1514.321);
   htemp->SetBinContent(3,1514.321);
   htemp->SetBinContent(4,1011.513);
   htemp->SetBinContent(5,1011.513);
   htemp->SetBinContent(6,647.8063);
   htemp->SetBinContent(7,647.8063);
   htemp->SetBinContent(8,315.6897);
   htemp->SetBinContent(9,315.6897);
   htemp->SetBinContent(10,150.1579);
   htemp->SetBinContent(11,150.1579);
   htemp->SetBinContent(12,62.02176);
   htemp->SetBinContent(13,62.02176);
   htemp->SetBinContent(14,29.06283);
   htemp->SetBinContent(15,29.06283);
   htemp->SetBinContent(16,29.06283);
   htemp->SetBinContent(17,4.949105);
   htemp->SetBinContent(18,4.949105);
   htemp->SetBinError(1,15.65859);
   htemp->SetBinError(2,12.62767);
   htemp->SetBinError(3,12.62767);
   htemp->SetBinError(4,10.32048);
   htemp->SetBinError(5,10.32048);
   htemp->SetBinError(6,8.259181);
   htemp->SetBinError(7,8.259181);
   htemp->SetBinError(8,5.765601);
   htemp->SetBinError(9,5.765601);
   htemp->SetBinError(10,3.976386);
   htemp->SetBinError(11,3.976386);
   htemp->SetBinError(12,2.555562);
   htemp->SetBinError(13,2.555562);
   htemp->SetBinError(14,1.749377);
   htemp->SetBinError(15,1.749377);
   htemp->SetBinError(16,1.749377);
   htemp->SetBinError(17,0.7219012);
   htemp->SetBinError(18,0.7219012);
   htemp->SetEntries(30);
   htemp->SetStats(0);
