...
//=========  (Mon Nov 21 23:01:11 2016) by ROOT version5.34/07
   ...
   htemp__38->SetBinContent(1,1248);
   htemp__38->SetBinContent(2,1248);
   htemp__38->SetBinContent(3,948);
   htemp__38->SetBinContent(4,732);
   htemp__38->SetBinContent(5,573);
   htemp__38->SetBinContent(6,414);
   htemp__38->SetBinContent(7,267);
   htemp__38->SetBinContent(8,156);
   htemp__38->SetBinContent(9,75);
   htemp__38->SetBinContent(10,54);
   htemp__38->SetBinContent(11,15);
   htemp__38->SetBinContent(12,9);
   htemp__38->SetBinContent(13,9);
   htemp__38->SetBinContent(14,9);
   htemp__38->SetBinContent(15,6);
   htemp__38->SetBinContent(16,6);
   htemp__38->SetBinContent(17,6);
   htemp__38->SetBinContent(18,6);
   htemp__38->SetBinContent(19,3);
   htemp__38->SetBinContent(20,3);
   htemp__38->SetBinError(1,61.18823);
   htemp__38->SetBinError(2,61.18823);
   htemp__38->SetBinError(3,53.32917);
   htemp__38->SetBinError(4,46.8615);
   htemp__38->SetBinError(5,41.46082);
   htemp__38->SetBinError(6,35.24202);
   htemp__38->SetBinError(7,28.30194);
   htemp__38->SetBinError(8,21.63331);
   htemp__38->SetBinError(9,15);
   htemp__38->SetBinError(10,12.72792);
   htemp__38->SetBinError(11,6.708204);
   htemp__38->SetBinError(12,5.196152);
   htemp__38->SetBinError(13,5.196152);
   htemp__38->SetBinError(14,5.196152);
   htemp__38->SetBinError(15,4.242641);
   htemp__38->SetBinError(16,4.242641);
   htemp__38->SetBinError(17,4.242641);
   htemp__38->SetBinError(18,4.242641);
   ...
   htemp->SetBinContent(1,1713);
   htemp->SetBinContent(2,1041);
   htemp->SetBinContent(3,1041);
   htemp->SetBinContent(4,684);
   htemp->SetBinContent(5,684);
   htemp->SetBinContent(6,534);
   htemp->SetBinContent(7,534);
   htemp->SetBinContent(8,414);
   htemp->SetBinContent(9,414);
   htemp->SetBinContent(10,363);
   htemp->SetBinContent(11,363);
   htemp->SetBinContent(12,315);
   htemp->SetBinContent(13,315);
   htemp->SetBinContent(14,303);
   htemp->SetBinContent(15,303);
   htemp->SetBinContent(16,303);
   htemp->SetBinContent(17,291);
   htemp->SetBinContent(18,291);
   htemp->SetBinContent(19,291);
   htemp->SetBinContent(20,291);
   htemp->SetBinContent(21,291);
   htemp->SetBinContent(22,291);
   htemp->SetBinContent(23,291);
   htemp->SetBinContent(24,291);
   htemp->SetBinContent(25,291);
   htemp->SetBinContent(26,291);
   htemp->SetBinContent(27,291);
   htemp->SetBinContent(28,291);
   htemp->SetBinError(1,71.68682);
   htemp->SetBinError(2,55.88381);
   htemp->SetBinError(3,55.88381);
   htemp->SetBinError(4,45.29901);
   htemp->SetBinError(5,45.29901);
   htemp->SetBinError(6,40.02499);
   htemp->SetBinError(7,40.02499);
   htemp->SetBinError(8,35.24202);
   htemp->SetBinError(9,35.24202);
   htemp->SetBinError(10,33);
   htemp->SetBinError(11,33);
   htemp->SetBinError(12,30.74085);
   htemp->SetBinError(13,30.74085);
   htemp->SetBinError(14,30.14963);
   htemp->SetBinError(15,30.14963);
   htemp->SetBinError(16,30.14963);
   htemp->SetBinError(17,29.54657);
   htemp->SetBinError(18,29.54657);
   htemp->SetBinError(19,29.54657);
   htemp->SetBinError(20,29.54657);
   htemp->SetBinError(21,29.54657);
   htemp->SetBinError(22,29.54657);
   htemp->SetBinError(23,29.54657);
   htemp->SetBinError(24,29.54657);
   htemp->SetBinError(25,29.54657);
   htemp->SetBinError(26,29.54657);
   htemp->SetBinError(27,29.54657);
   htemp->SetBinError(28,29.54657);
   htemp->SetEntries(30);
   htemp->SetStats(0);
