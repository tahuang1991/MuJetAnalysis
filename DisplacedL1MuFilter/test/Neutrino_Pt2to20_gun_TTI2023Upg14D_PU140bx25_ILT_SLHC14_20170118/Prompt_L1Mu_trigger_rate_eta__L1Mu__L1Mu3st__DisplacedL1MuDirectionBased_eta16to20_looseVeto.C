...
//=========  (Wed Jan 18 15:36:37 2017) by ROOT version5.34/07
   ...
   TH1F *b1 = new TH1F("b1","           #scale[1.4]{#font[61]{CMS}} #font[52]{Simulation preliminary}                                                           14 TeV, 140 PU",50, xAxis147);
   b1->SetMinimum(0);
   b1->SetMaximum(50);
   b1->SetStats(0);
   ...
   entry->SetMarkerStyle(21);
   entry->SetMarkerSize(1);
   entry=leg->AddEntry("_clone","Displaced L1Mu, hit in GE11, ME11, GE21, ME21 direction based, loose veto","f");
