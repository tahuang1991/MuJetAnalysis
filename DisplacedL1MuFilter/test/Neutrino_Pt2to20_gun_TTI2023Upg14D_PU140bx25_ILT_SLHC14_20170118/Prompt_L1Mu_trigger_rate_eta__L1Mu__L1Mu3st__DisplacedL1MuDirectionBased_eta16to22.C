...
//=========  (Wed Jan 18 15:36:36 2017) by ROOT version5.34/07
   ...
   _clone->SetBinContent(36,12);
   _clone->SetBinContent(37,24);
   _clone->SetBinContent(38,45);
   _clone->SetBinContent(39,39);
   _clone->SetBinContent(40,45);
   _clone->SetBinContent(41,57);
   _clone->SetBinContent(42,45);
   _clone->SetBinContent(43,66);
   _clone->SetBinContent(44,6);
   _clone->SetBinError(35,3);
   _clone->SetBinError(36,6);
   _clone->SetBinError(37,8.485281);
   _clone->SetBinError(38,11.61895);
   _clone->SetBinError(39,10.81665);
   _clone->SetBinError(40,11.61895);
   _clone->SetBinError(41,13.0767);
   _clone->SetBinError(42,11.61895);
   _clone->SetBinError(43,14.07125);
   _clone->SetBinError(44,4.242641);
   _clone->SetEntries(114);
