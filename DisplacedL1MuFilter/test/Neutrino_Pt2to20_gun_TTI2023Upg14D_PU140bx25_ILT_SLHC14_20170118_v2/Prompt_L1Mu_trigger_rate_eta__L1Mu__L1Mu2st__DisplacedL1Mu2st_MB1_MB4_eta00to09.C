...
//=========  (Wed Jan 18 17:59:42 2017) by ROOT version5.34/07
   ...
   TH1F *b1 = new TH1F("b1","           #scale[1.4]{#font[61]{CMS}} #font[52]{Simulation preliminary}                                                           14 TeV, 140 PU",50, xAxis156);
   b1->SetMinimum(0);
   b1->SetMaximum(50);
   b1->SetStats(0);
   ...
   TH1F *_clone = new TH1F("_clone","",50, xAxis157);
   ...
   TH1F *_clone = new TH1F("_clone","",50, xAxis158);
