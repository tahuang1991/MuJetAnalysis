...
//=========  (Wed Jan 18 20:15:10 2017) by ROOT version5.34/07
   ...
   TH1F *_clone = new TH1F("_clone","",50, xAxis90);
   ...
   TH1F *_clone = new TH1F("_clone","",50, xAxis91);
   _clone->SetBinContent(35,3);
   _clone->SetBinContent(38,6);
   ...
   TH1F *_clone = new TH1F("_clone","",50, xAxis92);
   _clone->SetBinContent(35,3);
   ...
   entry->SetMarkerStyle(21);
   entry->SetMarkerSize(1);
   entry=leg->AddEntry("_clone","Prompt L1Mu, 2 CSC stubs, ME11, GE11, ME21, GE21","p");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
