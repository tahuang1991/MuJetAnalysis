...
//=========  (Tue Jan 31 12:06:34 2017) by ROOT version5.34/07
   ...
   c->SetFrameBorderMode(0);
   Double_t xAxis183[30] = {1, 2, 2.5, 3, 3.5, 4, 4.5, 5, 6, 7, 8, 10, 12, 14, 16, 18, 20, 25, 30, 35, 40, 45, 50, 60, 70, 80, 90, 100, 120, 140}; 
   
   TH1F *b1 = new TH1F("b1","           #scale[1.4]{#font[61]{CMS}} #font[52]{Simulation preliminary}                                                           14 TeV, 140 PU",29, xAxis183);
   b1->SetMinimum(0.2);
   b1->SetMaximum(10000);
   b1->SetStats(0);
   ...
   b1->Draw("");
   Double_t xAxis184[29] = {2, 2.5, 3, 3.5, 4, 4.5, 5, 6, 7, 8, 10, 12, 14, 16, 18, 20, 25, 30, 35, 40, 45, 50, 60, 70, 80, 90, 100, 120, 140}; 
   
   TH1F *htemp__53 = new TH1F("htemp__53"," ",28, xAxis184);
   ...
   TH1F *htemp__54 = new TH1F("htemp__54"," ",28, xAxis185);
   ...
   TH1F *htemp = new TH1F("htemp"," ",28, xAxis186);
   htemp->SetEntries(30);
   htemp->SetStats(0);
