...
//=========  (Tue Jan 31 12:06:34 2017) by ROOT version5.34/07
   ...
   c->SetFrameBorderMode(0);
   Double_t xAxis175[30] = {1, 2, 2.5, 3, 3.5, 4, 4.5, 5, 6, 7, 8, 10, 12, 14, 16, 18, 20, 25, 30, 35, 40, 45, 50, 60, 70, 80, 90, 100, 120, 140}; 
   
   TH1F *b1 = new TH1F("b1","           #scale[1.4]{#font[61]{CMS}} #font[52]{Simulation preliminary}                                                           14 TeV, 140 PU",29, xAxis175);
   b1->SetMinimum(0.2);
   b1->SetMaximum(10000);
   b1->SetStats(0);
   ...
   b1->Draw("");
   Double_t xAxis176[29] = {2, 2.5, 3, 3.5, 4, 4.5, 5, 6, 7, 8, 10, 12, 14, 16, 18, 20, 25, 30, 35, 40, 45, 50, 60, 70, 80, 90, 100, 120, 140}; 
   
   TH1F *htemp__49 = new TH1F("htemp__49"," ",28, xAxis176);
   htemp__49->SetBinContent(1,1495.5);
   htemp__49->SetBinContent(2,1495.5);
   htemp__49->SetBinContent(3,1113.6);
   htemp__49->SetBinContent(4,851.7);
   htemp__49->SetBinContent(5,689.7);
   htemp__49->SetBinContent(6,530.1);
   htemp__49->SetBinContent(7,373.2);
   htemp__49->SetBinContent(8,225);
   htemp__49->SetBinContent(9,124.2);
   htemp__49->SetBinContent(10,90);
   htemp__49->SetBinContent(11,46.8);
   htemp__49->SetBinContent(12,32.7);
   htemp__49->SetBinContent(13,19.5);
   htemp__49->SetBinContent(14,16.5);
   htemp__49->SetBinContent(15,12.3);
   htemp__49->SetBinContent(16,10.5);
   htemp__49->SetBinContent(17,7.8);
   htemp__49->SetBinContent(18,6.3);
   htemp__49->SetBinContent(19,4.8);
   htemp__49->SetBinContent(20,4.8);
   htemp__49->SetBinContent(21,4.5);
   htemp__49->SetBinContent(22,4.2);
   htemp__49->SetBinContent(23,3.6);
   htemp__49->SetBinContent(24,2.7);
   htemp__49->SetBinContent(25,2.7);
   htemp__49->SetBinContent(26,2.7);
   htemp__49->SetBinContent(27,2.4);
   htemp__49->SetBinContent(28,2.1);
   htemp__49->SetBinError(1,21.18136);
   htemp__49->SetBinError(2,21.18136);
   htemp__49->SetBinError(3,18.27786);
   htemp__49->SetBinError(4,15.98468);
   htemp__49->SetBinError(5,14.38437);
   htemp__49->SetBinError(6,12.61071);
   htemp__49->SetBinError(7,10.58112);
   htemp__49->SetBinError(8,8.215838);
   htemp__49->SetBinError(9,6.104097);
   htemp__49->SetBinError(10,5.196152);
   htemp__49->SetBinError(11,3.746999);
   htemp__49->SetBinError(12,3.132092);
   htemp__49->SetBinError(13,2.418677);
   htemp__49->SetBinError(14,2.22486);
   htemp__49->SetBinError(15,1.920937);
   htemp__49->SetBinError(16,1.774824);
   htemp__49->SetBinError(17,1.529706);
   htemp__49->SetBinError(18,1.374773);
   htemp__49->SetBinError(19,1.2);
   htemp__49->SetBinError(20,1.2);
   htemp__49->SetBinError(21,1.161895);
   htemp__49->SetBinError(22,1.122497);
   htemp__49->SetBinError(23,1.03923);
   htemp__49->SetBinError(24,0.9);
   htemp__49->SetBinError(25,0.9);
   htemp__49->SetBinError(26,0.9);
   htemp__49->SetBinError(27,0.8485281);
   htemp__49->SetBinError(28,0.7937254);
   ...
   TH1F *htemp__50 = new TH1F("htemp__50"," ",28, xAxis177);
...
tex->SetNDC();
   ...
   TH1F *htemp = new TH1F("htemp"," ",28, xAxis178);
   htemp->SetEntries(41);
   htemp->SetStats(0);
