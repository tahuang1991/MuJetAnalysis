...
#ch = addfiles(ch, dirname='/eos/uscms/store/user/lpcgem/DarkSUSY_MH-125_MGammaD-20000_ctau1000_14TeV_madgraph-pythia6-tauola/DarkSUSY_mH_125_mGammaD_20000_cT_1000_14TeV_PU140_L1MuANA/160627_185322/0000/', ext=".root")
  ...
  def displacedTriggerEfficiency():
    ...
    dPhist1_vs_dPhiBendst1_even = TH2F("dPhist1_vs_dPhiBendst1_even","", 100,-0.01,0.01,100,-0.2,0.2)
    dPhist1_vs_dPhiBendst1_odd = TH2F("dPhist1_vs_dPhiBendst1_odd","", 100,-0.01,0.01,100,-0.2,0.2)
    dPhist2_vs_dPhiBendst2_even = TH2F("dPhist2_vs_dPhiBendst2_even","", 100,-0.01,0.01,100,-0.2,0.2)
    dPhist2_vs_dPhiBendst2_odd = TH2F("dPhist2_vs_dPhiBendst2_odd","", 100,-0.01,0.01,100,-0.2,0.2)
    dPhist1_vs_dPhiBendst1_even_pt10 = TH2F("dPhist1_vs_dPhiBendst1_even_pt10","", 100,-0.01,0.01,100,-0.2,0.2)
    dPhist1_vs_dPhiBendst1_odd_pt10 = TH2F("dPhist1_vs_dPhiBendst1_odd_pt10","", 100,-0.01,0.01,100,-0.2,0.2)
    dPhist2_vs_dPhiBendst2_even_pt10 = TH2F("dPhist2_vs_dPhiBendst2_even_pt10","", 100,-0.01,0.01,100,-0.2,0.2)
    dPhist2_vs_dPhiBendst2_odd_pt10 = TH2F("dPhist2_vs_dPhiBendst2_odd_pt10","", 100,-0.01,0.01,100,-0.2,0.2)

    dPhist1_vs_dPhiBendst1_even_v2 = TH2F("dPhist1_vs_dPhiBendst1_even_v2","", 100,-3.2,3.2,100,-3.2,3.2)
    dPhist1_vs_dPhiBendst1_odd_v2 = TH2F("dPhist1_vs_dPhiBendst1_odd_v2","", 100,-3.2,3.2,100,-3.2,3.2)
    dPhist2_vs_dPhiBendst2_even_v2 = TH2F("dPhist2_vs_dPhiBendst2_even_v2","", 100,-3.2,3.2,100,-3.2,3.2)
    dPhist2_vs_dPhiBendst2_odd_v2 = TH2F("dPhist2_vs_dPhiBendst2_odd_v2","", 100,-3.2,3.2,100,-3.2,3.2)
    dPhist1_vs_dPhiBendst1_even_pt10_v2 = TH2F("dPhist1_vs_dPhiBendst1_even_pt10_v2","", 100,-3.2,3.2,100,-3.2,3.2)
    dPhist1_vs_dPhiBendst1_odd_pt10_v2 = TH2F("dPhist1_vs_dPhiBendst1_odd_pt10_v2","", 100,-3.2,3.2,100,-3.2,3.2)
    dPhist2_vs_dPhiBendst2_even_pt10_v2 = TH2F("dPhist2_vs_dPhiBendst2_even_pt10_v2","", 100,-3.2,3.2,100,-3.2,3.2)
    dPhist2_vs_dPhiBendst2_odd_pt10_v2 = TH2F("dPhist2_vs_dPhiBendst2_odd_pt10_v2","", 100,-3.2,3.2,100,-3.2,3.2)
    ...
    slope_vs_GenMuEta_GE11_even =  TH2F("slope_vs_GenMuEta_GE11_even","", 20,1.5,2.5,200,-25.,75.)
    slope_vs_GenMuEta_GE11_odd =  TH2F("slope_vs_GenMuEta_GE11_odd","", 20,1.5,2.5,200,-25.,75.)
    slope_vs_GenMuEta_GE21_even =  TH2F("slope_vs_GenMuEta_GE21_even","", 20,1.5,2.5,200,-25.,75.)
    slope_vs_GenMuEta_GE21_odd =  TH2F("slope_vs_GenMuEta_GE21_odd","", 20,1.5,2.5,200,-25.,75.)

    slope_GE11_even = TH1F("slope_GE11_even","", 200,-25.,75.)
    slope_GE11_odd = TH1F("slope_GE11_odd","", 200,-25.,75.)
...
#            print "dR_corr", treeHits.genGdMu_L1Mu_dR_corr[ij],
          ...
          if L1Mu_index != 99 and L1Mu_dR_prop < 0.2:
            ...
            if m_CSCTF:
              ...
              if ok_direction_based_endcap:
                ...
                delta_phi_GE21_ME21 = deltaPhi2(CSCTF_phi2, GE21_phi)
                ...
                def phi_dir_st1_variable_GE21_pad_size(me11_phi, ge11_phi, me21_phi, ge21_phi):
                  numerator = TMath.Sin( deltaPhi2(me11_phi, ge11_phi) )
                  denominator = 1. - TMath.Cos( deltaPhi2(me21_phi, ge21_phi) ) - delta_z_GE11_ME11 * X
                  return ge11_phi - TMath.ATan( numerator / denominator)

                def phi_dir_st2_variable_GE21_pad_size(me11_phi, ge11_phi, me21_phi, ge21_phi):
                  numerator = TMath.Sin( deltaPhi2(me11_phi, ge11_phi) )
                  denominator = 1 - TMath.Cos( deltaPhi2(me21_phi, ge21_phi) ) - (delta_z_GE21_ME21 * X / (delta_z_ME11_ME21 * X+1 ) )
                  return ge21_phi - TMath.ATan( numerator / denominator )

                phi_dir_st1_GE21_pad1 = phi_dir_st1_variable_GE21_pad_size(CSCTF_phi1, GE11_phi, CSCTF_phi2, GE21_pad1_phi)
                phi_dir_st1_GE21_pad2 = phi_dir_st1_variable_GE21_pad_size(CSCTF_phi1, GE11_phi, CSCTF_phi2, GE21_pad2_phi)
                phi_dir_st1_GE21_pad4 = phi_dir_st1_variable_GE21_pad_size(CSCTF_phi1, GE11_phi, CSCTF_phi2, GE21_pad4_phi)
                phi_dir_st1_GE21_pad8 = phi_dir_st1_variable_GE21_pad_size(CSCTF_phi1, GE11_phi, CSCTF_phi2, GE21_pad8_phi)

                phi_dir_st2_GE21_pad1 = phi_dir_st2_variable_GE21_pad_size(CSCTF_phi1, GE11_phi, CSCTF_phi2, GE21_pad1_phi)
                phi_dir_st2_GE21_pad2 = phi_dir_st2_variable_GE21_pad_size(CSCTF_phi1, GE11_phi, CSCTF_phi2, GE21_pad2_phi)
                phi_dir_st2_GE21_pad4 = phi_dir_st2_variable_GE21_pad_size(CSCTF_phi1, GE11_phi, CSCTF_phi2, GE21_pad4_phi)
                phi_dir_st2_GE21_pad8 = phi_dir_st2_variable_GE21_pad_size(CSCTF_phi1, GE11_phi, CSCTF_phi2, GE21_pad8_phi)
                
                delta_phi_dir_GE21_pad1 = abs( deltaPhi2( phi_dir_st1_GE21_pad1, phi_dir_st2_GE21_pad1) )
                delta_phi_dir_GE21_pad2 = abs( deltaPhi2( phi_dir_st1_GE21_pad2, phi_dir_st2_GE21_pad2) )
                delta_phi_dir_GE21_pad4 = abs( deltaPhi2( phi_dir_st1_GE21_pad4, phi_dir_st2_GE21_pad4) )
                delta_phi_dir_GE21_pad8 = abs( deltaPhi2( phi_dir_st1_GE21_pad8, phi_dir_st2_GE21_pad8) )

                if delta_phi_dir_GE21_pad1 != 0: inv_delta_phi_dir_GE21_pad1 = 1./delta_phi_dir_GE21_pad1
                else:                            inv_delta_phi_dir_GE21_pad1 = 140
                if delta_phi_dir_GE21_pad2 != 0: inv_delta_phi_dir_GE21_pad2 = 1./delta_phi_dir_GE21_pad2
                else:                            inv_delta_phi_dir_GE21_pad2 = 140
                if delta_phi_dir_GE21_pad4 != 0: inv_delta_phi_dir_GE21_pad4 = 1./delta_phi_dir_GE21_pad4
                else:                            inv_delta_phi_dir_GE21_pad4 = 140
                if delta_phi_dir_GE21_pad8 != 0: inv_delta_phi_dir_GE21_pad8 = 1./delta_phi_dir_GE21_pad8
                else:                            inv_delta_phi_dir_GE21_pad8 = 140

                
                if CSCTF_isEven1 and CSCTF_isEven2:
                  if (1.6 < abs(eta_prop) and abs(eta_prop) < 1.8): 
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta16to18_ee_pad1"].Fill(pt, inv_delta_phi_dir_GE21_pad1)
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta16to18_ee_pad2"].Fill(pt, inv_delta_phi_dir_GE21_pad2)
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta16to18_ee_pad4"].Fill(pt, inv_delta_phi_dir_GE21_pad4)
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta16to18_ee_pad8"].Fill(pt, inv_delta_phi_dir_GE21_pad8)
                  if (1.8 < abs(eta_prop) and abs(eta_prop) < 2.0): 
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta18to20_ee_pad1"].Fill(pt, inv_delta_phi_dir_GE21_pad1)
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta18to20_ee_pad2"].Fill(pt, inv_delta_phi_dir_GE21_pad2)
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta18to20_ee_pad4"].Fill(pt, inv_delta_phi_dir_GE21_pad4)
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta18to20_ee_pad8"].Fill(pt, inv_delta_phi_dir_GE21_pad8)
                  if (2.0 < abs(eta_prop) and abs(eta_prop) < 2.2): 
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta20to22_ee_pad1"].Fill(pt, inv_delta_phi_dir_GE21_pad1)
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta20to22_ee_pad2"].Fill(pt, inv_delta_phi_dir_GE21_pad2)
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta20to22_ee_pad4"].Fill(pt, inv_delta_phi_dir_GE21_pad4)
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta20to22_ee_pad8"].Fill(pt, inv_delta_phi_dir_GE21_pad8)

                if CSCTF_isEven1 and CSCTF_isOdd2:
                  if (1.6 < abs(eta_prop) and abs(eta_prop) < 1.8): 
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta16to18_eo_pad1"].Fill(pt, inv_delta_phi_dir_GE21_pad1)
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta16to18_eo_pad2"].Fill(pt, inv_delta_phi_dir_GE21_pad2)
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta16to18_eo_pad4"].Fill(pt, inv_delta_phi_dir_GE21_pad4)
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta16to18_eo_pad8"].Fill(pt, inv_delta_phi_dir_GE21_pad8)
                  if (1.8 < abs(eta_prop) and abs(eta_prop) < 2.0): 
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta18to20_eo_pad1"].Fill(pt, inv_delta_phi_dir_GE21_pad1)
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta18to20_eo_pad2"].Fill(pt, inv_delta_phi_dir_GE21_pad2)
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta18to20_eo_pad4"].Fill(pt, inv_delta_phi_dir_GE21_pad4)
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta18to20_eo_pad8"].Fill(pt, inv_delta_phi_dir_GE21_pad8)
                  if (2.0 < abs(eta_prop) and abs(eta_prop) < 2.2): 
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta20to22_eo_pad1"].Fill(pt, inv_delta_phi_dir_GE21_pad1)
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta20to22_eo_pad2"].Fill(pt, inv_delta_phi_dir_GE21_pad2)
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta20to22_eo_pad4"].Fill(pt, inv_delta_phi_dir_GE21_pad4)
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta20to22_eo_pad8"].Fill(pt, inv_delta_phi_dir_GE21_pad8)

                if CSCTF_isOdd1 and CSCTF_isEven2:
                  if (1.6 < abs(eta_prop) and abs(eta_prop) < 1.8): 
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta16to18_oe_pad1"].Fill(pt, inv_delta_phi_dir_GE21_pad1)
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta16to18_oe_pad2"].Fill(pt, inv_delta_phi_dir_GE21_pad2)
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta16to18_oe_pad4"].Fill(pt, inv_delta_phi_dir_GE21_pad4)
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta16to18_oe_pad8"].Fill(pt, inv_delta_phi_dir_GE21_pad8)
                  if (1.8 < abs(eta_prop) and abs(eta_prop) < 2.0): 
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta18to20_oe_pad1"].Fill(pt, inv_delta_phi_dir_GE21_pad1)
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta18to20_oe_pad2"].Fill(pt, inv_delta_phi_dir_GE21_pad2)
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta18to20_oe_pad4"].Fill(pt, inv_delta_phi_dir_GE21_pad4)
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta18to20_oe_pad8"].Fill(pt, inv_delta_phi_dir_GE21_pad8)
                  if (2.0 < abs(eta_prop) and abs(eta_prop) < 2.2): 
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta20to22_oe_pad1"].Fill(pt, inv_delta_phi_dir_GE21_pad1)
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta20to22_oe_pad2"].Fill(pt, inv_delta_phi_dir_GE21_pad2)
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta20to22_oe_pad4"].Fill(pt, inv_delta_phi_dir_GE21_pad4)
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta20to22_oe_pad8"].Fill(pt, inv_delta_phi_dir_GE21_pad8)

                if CSCTF_isOdd1 and CSCTF_isOdd2:
                  if (1.6 < abs(eta_prop) and abs(eta_prop) < 1.8): 
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta16to18_oo_pad1"].Fill(pt, inv_delta_phi_dir_GE21_pad1)
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta16to18_oo_pad2"].Fill(pt, inv_delta_phi_dir_GE21_pad2)
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta16to18_oo_pad4"].Fill(pt, inv_delta_phi_dir_GE21_pad4)
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta16to18_oo_pad8"].Fill(pt, inv_delta_phi_dir_GE21_pad8)
                  if (1.8 < abs(eta_prop) and abs(eta_prop) < 2.0): 
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta18to20_oo_pad1"].Fill(pt, inv_delta_phi_dir_GE21_pad1)
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta18to20_oo_pad2"].Fill(pt, inv_delta_phi_dir_GE21_pad2)
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta18to20_oo_pad4"].Fill(pt, inv_delta_phi_dir_GE21_pad4)
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta18to20_oo_pad8"].Fill(pt, inv_delta_phi_dir_GE21_pad8)
                  if (2.0 < abs(eta_prop) and abs(eta_prop) < 2.2): 
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta20to22_oo_pad1"].Fill(pt, inv_delta_phi_dir_GE21_pad1)
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta20to22_oo_pad2"].Fill(pt, inv_delta_phi_dir_GE21_pad2)
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta20to22_oo_pad4"].Fill(pt, inv_delta_phi_dir_GE21_pad4)
                    mapTH2F["GenMuPt_vs_abs_phiGEMst1_phiGEMst2_inv_eta20to22_oo_pad8"].Fill(pt, inv_delta_phi_dir_GE21_pad8)
    ...
    makeSimplePlot(slope_vs_GenMuEta_GE21_even, targetDir + "slope_vs_GenMuEta_GE21_even.png", "; GEN Mu #eta; slope", "COLZ") 
    makeSimplePlot(slope_vs_GenMuEta_GE21_odd, targetDir + "slope_vs_GenMuEta_GE21_odd.png", "; GEN Mu #eta; slope", "COLZ") 

    makeSimplePlot(slope_GE11_even, targetDir + "slope_GE11_even.png", "; slope") 
    ...
    """
    makeEffPlot(TEfficiency(Prompt_L1MuPt10_GenMuPt_dxy0to5_barrel, GenMuPt_dxy0to5_barrel),
                TEfficiency(Prompt_L1MuPt10_GenMuPt_dxy5to50_barrel, GenMuPt_dxy5to50_barrel),
                TEfficiency(Prompt_L1MuPt10_GenMuPt_dxy50to100_barrel, GenMuPt_dxy50to100_barrel),
                targetDir + "Prompt_L1MuPt10_GenMuPt_dxy0to100_barrel.png", True)

    makeEffPlot(TEfficiency(Prompt_L1MuPt15_GenMuPt_dxy0to5_barrel, GenMuPt_dxy0to5_barrel),
                TEfficiency(Prompt_L1MuPt15_GenMuPt_dxy5to50_barrel, GenMuPt_dxy5to50_barrel),
                TEfficiency(Prompt_L1MuPt15_GenMuPt_dxy50to100_barrel, GenMuPt_dxy50to100_barrel),
                targetDir + "Prompt_L1MuPt15_GenMuPt_dxy0to100_barrel.png", True)

    makeEffPlot(TEfficiency(Prompt_L1MuPt20_GenMuPt_dxy0to5_barrel, GenMuPt_dxy0to5_barrel),
                TEfficiency(Prompt_L1MuPt20_GenMuPt_dxy5to50_barrel, GenMuPt_dxy5to50_barrel),
                TEfficiency(Prompt_L1MuPt20_GenMuPt_dxy50to100_barrel, GenMuPt_dxy50to100_barrel),
                targetDir + "Prompt_L1MuPt20_GenMuPt_dxy0to100_barrel.png", True)


    makeEffPlot(TEfficiency(Prompt_L1MuPt10_GenMuPt_dxy0to5_overlap, GenMuPt_dxy0to5_overlap),
                TEfficiency(Prompt_L1MuPt10_GenMuPt_dxy5to50_overlap, GenMuPt_dxy5to50_overlap),
                TEfficiency(Prompt_L1MuPt10_GenMuPt_dxy50to100_overlap, GenMuPt_dxy50to100_overlap),
                targetDir + "Prompt_L1MuPt10_GenMuPt_dxy0to100_overlap.png", True)

    makeEffPlot(TEfficiency(Prompt_L1MuPt15_GenMuPt_dxy0to5_overlap, GenMuPt_dxy0to5_overlap),
                TEfficiency(Prompt_L1MuPt15_GenMuPt_dxy5to50_overlap, GenMuPt_dxy5to50_overlap),
                TEfficiency(Prompt_L1MuPt15_GenMuPt_dxy50to100_overlap, GenMuPt_dxy50to100_overlap),
                targetDir + "Prompt_L1MuPt15_GenMuPt_dxy0to100_overlap.png", True)

    makeEffPlot(TEfficiency(Prompt_L1MuPt20_GenMuPt_dxy0to5_overlap, GenMuPt_dxy0to5_overlap),
                TEfficiency(Prompt_L1MuPt20_GenMuPt_dxy5to50_overlap, GenMuPt_dxy5to50_overlap),
                TEfficiency(Prompt_L1MuPt20_GenMuPt_dxy50to100_overlap, GenMuPt_dxy50to100_overlap),
                targetDir + "Prompt_L1MuPt20_GenMuPt_dxy0to100_overlap.png", True)


    makeEffPlot(TEfficiency(Prompt_L1MuPt10_GenMuPt_dxy0to5_endcap, GenMuPt_dxy0to5_endcap),
                TEfficiency(Prompt_L1MuPt10_GenMuPt_dxy5to50_endcap, GenMuPt_dxy5to50_endcap),
                TEfficiency(Prompt_L1MuPt10_GenMuPt_dxy50to100_endcap, GenMuPt_dxy50to100_endcap),
                targetDir + "Prompt_L1MuPt10_GenMuPt_dxy0to100_endcap.png", True)

    makeEffPlot(TEfficiency(Prompt_L1MuPt15_GenMuPt_dxy0to5_endcap, GenMuPt_dxy0to5_endcap),
                TEfficiency(Prompt_L1MuPt15_GenMuPt_dxy5to50_endcap, GenMuPt_dxy5to50_endcap),
                TEfficiency(Prompt_L1MuPt15_GenMuPt_dxy50to100_endcap, GenMuPt_dxy50to100_endcap),
                targetDir + "Prompt_L1MuPt15_GenMuPt_dxy0to100_endcap.png", True)

    makeEffPlot(TEfficiency(Prompt_L1MuPt20_GenMuPt_dxy0to5_endcap, GenMuPt_dxy0to5_endcap),
                TEfficiency(Prompt_L1MuPt20_GenMuPt_dxy5to50_endcap, GenMuPt_dxy5to50_endcap),
                TEfficiency(Prompt_L1MuPt20_GenMuPt_dxy50to100_endcap, GenMuPt_dxy50to100_endcap),
                targetDir + "Prompt_L1MuPt20_GenMuPt_dxy0to100_endcap.png", True)



    makeEffPlot(TEfficiency(Displaced_L1MuPt10_GenMuPt_dxy0to5, GenMuPt_dxy0to5),
                TEfficiency(Displaced_L1MuPt10_GenMuPt_dxy5to50, GenMuPt_dxy5to50),
                TEfficiency(Displaced_L1MuPt10_GenMuPt_dxy50to100, GenMuPt_dxy50to100),
                targetDir + "Displaced_L1MuPt10_GenMuPt_dxy0to100.png", True)

    makeEffPlot(TEfficiency(Displaced_L1MuPt15_GenMuPt_dxy0to5, GenMuPt_dxy0to5),
                TEfficiency(Displaced_L1MuPt15_GenMuPt_dxy5to50, GenMuPt_dxy5to50),
                TEfficiency(Displaced_L1MuPt15_GenMuPt_dxy50to100, GenMuPt_dxy50to100),
                targetDir + "Displaced_L1MuPt15_GenMuPt_dxy0to100.png", True)

    makeEffPlot(TEfficiency(Displaced_L1MuPt20_GenMuPt_dxy0to5, GenMuPt_dxy0to5),
                TEfficiency(Displaced_L1MuPt20_GenMuPt_dxy5to50, GenMuPt_dxy5to50),
                TEfficiency(Displaced_L1MuPt20_GenMuPt_dxy50to100, GenMuPt_dxy50to100),
                targetDir + "Displaced_L1MuPt20_GenMuPt_dxy0to100.png", True)


    makeEffPlot(TEfficiency(Displaced_L1MuPt10_GenMuPt_dxy0to5_barrel, GenMuPt_dxy0to5_barrel),
                TEfficiency(Displaced_L1MuPt10_GenMuPt_dxy5to50_barrel, GenMuPt_dxy5to50_barrel),
                TEfficiency(Displaced_L1MuPt10_GenMuPt_dxy50to100_barrel, GenMuPt_dxy50to100_barrel),
                targetDir + "Displaced_L1MuPt10_GenMuPt_dxy0to100_barrel.png", True)

    makeEffPlot(TEfficiency(Displaced_L1MuPt15_GenMuPt_dxy0to5_barrel, GenMuPt_dxy0to5_barrel),
                TEfficiency(Displaced_L1MuPt15_GenMuPt_dxy5to50_barrel, GenMuPt_dxy5to50_barrel),
                TEfficiency(Displaced_L1MuPt15_GenMuPt_dxy50to100_barrel, GenMuPt_dxy50to100_barrel),
                targetDir + "Displaced_L1MuPt15_GenMuPt_dxy0to100_barrel.png", True)

    makeEffPlot(TEfficiency(Displaced_L1MuPt20_GenMuPt_dxy0to5_barrel, GenMuPt_dxy0to5_barrel),
                TEfficiency(Displaced_L1MuPt20_GenMuPt_dxy5to50_barrel, GenMuPt_dxy5to50_barrel),
                TEfficiency(Displaced_L1MuPt20_GenMuPt_dxy50to100_barrel, GenMuPt_dxy50to100_barrel),
                targetDir + "Displaced_L1MuPt20_GenMuPt_dxy0to100_barrel.png", True)


    makeEffPlot(TEfficiency(Displaced_L1MuPt10_GenMuPt_dxy0to5_overlap, GenMuPt_dxy0to5_overlap),
                TEfficiency(Displaced_L1MuPt10_GenMuPt_dxy5to50_overlap, GenMuPt_dxy5to50_overlap),
                TEfficiency(Displaced_L1MuPt10_GenMuPt_dxy50to100_overlap, GenMuPt_dxy50to100_overlap),
                targetDir + "Displaced_L1MuPt10_GenMuPt_dxy0to100_overlap.png", True)

    makeEffPlot(TEfficiency(Displaced_L1MuPt15_GenMuPt_dxy0to5_overlap, GenMuPt_dxy0to5_overlap),
                TEfficiency(Displaced_L1MuPt15_GenMuPt_dxy5to50_overlap, GenMuPt_dxy5to50_overlap),
                TEfficiency(Displaced_L1MuPt15_GenMuPt_dxy50to100_overlap, GenMuPt_dxy50to100_overlap),
                targetDir + "Displaced_L1MuPt15_GenMuPt_dxy0to100_overlap.png", True)

    makeEffPlot(TEfficiency(Displaced_L1MuPt20_GenMuPt_dxy0to5_overlap, GenMuPt_dxy0to5_overlap),
                TEfficiency(Displaced_L1MuPt20_GenMuPt_dxy5to50_overlap, GenMuPt_dxy5to50_overlap),
                TEfficiency(Displaced_L1MuPt20_GenMuPt_dxy50to100_overlap, GenMuPt_dxy50to100_overlap),
                targetDir + "Displaced_L1MuPt20_GenMuPt_dxy0to100_overlap.png", True)


    makeEffPlot(TEfficiency(Displaced_L1MuPt10_GenMuPt_dxy0to5_endcap, GenMuPt_dxy0to5_endcap),
                TEfficiency(Displaced_L1MuPt10_GenMuPt_dxy5to50_endcap, GenMuPt_dxy5to50_endcap),
                TEfficiency(Displaced_L1MuPt10_GenMuPt_dxy50to100_endcap, GenMuPt_dxy50to100_endcap),
                targetDir + "Displaced_L1MuPt10_GenMuPt_dxy0to100_endcap.png", True)

    makeEffPlot(TEfficiency(Displaced_L1MuPt15_GenMuPt_dxy0to5_endcap, GenMuPt_dxy0to5_endcap),
                TEfficiency(Displaced_L1MuPt15_GenMuPt_dxy5to50_endcap, GenMuPt_dxy5to50_endcap),
                TEfficiency(Displaced_L1MuPt15_GenMuPt_dxy50to100_endcap, GenMuPt_dxy50to100_endcap),
                targetDir + "Displaced_L1MuPt15_GenMuPt_dxy0to100_endcap.png", True)

    makeEffPlot(TEfficiency(Displaced_L1MuPt20_GenMuPt_dxy0to5_endcap, GenMuPt_dxy0to5_endcap),
                TEfficiency(Displaced_L1MuPt20_GenMuPt_dxy5to50_endcap, GenMuPt_dxy5to50_endcap),
                TEfficiency(Displaced_L1MuPt20_GenMuPt_dxy50to100_endcap, GenMuPt_dxy50to100_endcap),
                targetDir + "Displaced_L1MuPt20_GenMuPt_dxy0to100_endcap.png", True)
    """
