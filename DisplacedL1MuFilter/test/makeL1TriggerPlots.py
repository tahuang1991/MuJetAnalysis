...
if __name__ == "__main__":  
  ...
  draw_1D(treeHits,"dEta_L1Tk",  "dEta_L1Tk",  "dEta_L1Tk", "(100,0,1)")
  draw_1D(treeHits,"dPhi_L1Tk",  "dPhi_L1Tk",  "dPhi_L1Tk", "(100,0,1)")
  draw_1D(treeHits,"dR_L1Tk",  "dR_L1Tk",  "dR_L1Tk", "(100,0,1)")
  ...
  makeEtaEffPlot(getEffObject(treeHits, "abs(eta)", etaBinning, TCut("pt>10"), TCut("dR_sim_corr<0.2")), "eff_L1_eta_pt10_sim_corr", "dR(SIM,L1Mu)<0.2, p_{T} > 10 GeV")
  makeEtaEffPlot(getEffObject(treeHits, "abs(eta)", etaBinning, TCut("pt>15"), TCut("dR_sim_corr<0.2")), "eff_L1_eta_pt15_sim_corr", "dR(SIM,L1Mu)<0.2, p_{T} > 15 GeV")
  makeEtaEffPlot(getEffObject(treeHits, "abs(eta)", etaBinning, TCut("pt>20"), TCut("dR_sim_corr<0.2")), "eff_L1_eta_pt20_sim_corr", "dR(SIM,L1Mu)<0.2, p_{T} > 20 GeV")

  makeEtaEffPlot(getEffObject(treeHits, "abs(eta)", etaBinning, TCut("pt>10"), TCut("dR_sim_prop<0.2")), "eff_L1_eta_pt10_sim_prop", "dR(SIM,L1Mu)<0.2, p_{T} > 10 GeV")
  makeEtaEffPlot(getEffObject(treeHits, "abs(eta)", etaBinning, TCut("pt>15"), TCut("dR_sim_prop<0.2")), "eff_L1_eta_pt15_sim_prop", "dR(SIM,L1Mu)<0.2, p_{T} > 15 GeV")
  makeEtaEffPlot(getEffObject(treeHits, "abs(eta)", etaBinning, TCut("pt>20"), TCut("dR_sim_prop<0.2")), "eff_L1_eta_pt20_sim_prop", "dR(SIM,L1Mu)<0.2, p_{T} > 20 GeV")
