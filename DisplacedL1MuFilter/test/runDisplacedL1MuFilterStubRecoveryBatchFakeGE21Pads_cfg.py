...
process.DisplacedL1MuFilter_PhaseIIGE21 = cms.EDFilter("DisplacedL1MuFilter",
    ...
    addFakeGE21DigiPad = cms.bool(False),
    fakeGE21Pad_input = cms.InputTag("simMuonGEMCSCPadDigis"),
    fakeGE21Digi_input = cms.InputTag("simMuonGEMDigis"),
    simTrackMatching = SimTrackMatching,
    processRPCb = cms.bool(False),
    processRPCf = cms.bool(False),
    processTTI = cms.bool(True),
    processDTTF = cms.bool(True),
    doSimAnalysis = cms.bool(True),
    doGenAnalysis = cms.bool(True),
    doStubRecovery = cms.bool(True),
    ignoreGE21L2Pads = cms.bool(False),
)
...
process.DisplacedL1MuFilter_PhaseIIGE21FakePadsPU140 = process.DisplacedL1MuFilter_PhaseIIGE21.clone()
process.DisplacedL1MuFilter_PhaseIIGE21FakePadsPU200 = process.DisplacedL1MuFilter_PhaseIIGE21.clone()
process.DisplacedL1MuFilter_PhaseIIGE21FakePadsPU250 = process.DisplacedL1MuFilter_PhaseIIGE21.clone()

process.DisplacedL1MuFilter_PhaseIIGE21FakePadsPU140.addFakeGE21DigiPad = cms.bool(True)
process.DisplacedL1MuFilter_PhaseIIGE21FakePadsPU200.addFakeGE21DigiPad = cms.bool(True)
process.DisplacedL1MuFilter_PhaseIIGE21FakePadsPU250.addFakeGE21DigiPad = cms.bool(True)
process.DisplacedL1MuFilter_PhaseIIGE21FakePadsPU140.fakeGE21Pad_input = cms.InputTag("simMuonFakeGEMCSCPadDigisPU140")
process.DisplacedL1MuFilter_PhaseIIGE21FakePadsPU200.fakeGE21Pad_input = cms.InputTag("simMuonFakeGEMCSCPadDigisPU200")
process.DisplacedL1MuFilter_PhaseIIGE21FakePadsPU250.fakeGE21Pad_input = cms.InputTag("simMuonFakeGEMCSCPadDigisPU250")
process.DisplacedL1MuFilter_PhaseIIGE21FakePadsPU140.fakeGE21Digi_input = cms.InputTag("simMuonFakeGEMDigisPU140")
process.DisplacedL1MuFilter_PhaseIIGE21FakePadsPU200.fakeGE21Digi_input = cms.InputTag("simMuonFakeGEMDigisPU200")
process.DisplacedL1MuFilter_PhaseIIGE21FakePadsPU250.fakeGE21Digi_input = cms.InputTag("simMuonFakeGEMDigisPU250")

process.source = cms.Source(
    "PoolSource",
    fileNames = cms.untracked.vstring(options.inputFiles),
    #skipEvents=cms.untracked.uint32(0)
    #fileNames = cms.untracked.vstring('file:/eos/uscms/store/user/lpcgem/Neutrino_Pt2to20_gun/NeutrinoGun_14TeV_PU140_FakePad_20170508_v2/170509_021648/0000/out_fakedigi_149.root'),
    #fileNames = cms.untracked.vstring('file:/eos/uscms/store/user/lpcgem/Neutrino_Pt2to20_gun/NeutrinoGun_14TeV_PU140_FakePad_v1/170426_224915/0000/out_fakedigi_24.root'),
    #fileNames = cms.untracked.vstring('file:/eos/uscms/store/user/lpcgem/Neutrino_Pt2to20_gun/NeutrinoGun_14TeV_PU140_FakePad_v1/170426_224915/0002/out_fakedigi_2849.root')
...
process.p = cms.Path(
  process.DisplacedL1MuFilter_PhaseIIGE21*
  process.DisplacedL1MuFilter_PhaseIIGE21FakePadsPU140*
  process.DisplacedL1MuFilter_PhaseIIGE21FakePadsPU200*
  process.DisplacedL1MuFilter_PhaseIIGE21FakePadsPU250
)
