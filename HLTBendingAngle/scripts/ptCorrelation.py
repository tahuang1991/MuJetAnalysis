...
def pTCorrelationPlots(p):
    ...
    title =  ";|#eta|; (p_{T}^{SIM}-p_{T}^{RECO})/(1/p_{T}^{RECO})"
    binning = "(60, 0, 3.0, 100, -1.5, 10)"
    toplot = "((sim_pt-recoChargedCandidate_pt)/recoChargedCandidate_pt):abs(sim_eta)"

    draw_2D(p, "absEtaVsRelPt_3st", title, binning, toplot, AND(base_cut(), has_cand(), cand_3_st()), "COLZ")
    draw_2D(p, "absEtaVsRelPt_3st_pt1", title, binning, toplot, AND(base_cut(), has_cand(), sim_pt(1), cand_3_st()), "COLZ")
    draw_2D(p, "absEtaVsRelPt_3st_pt5", title, binning, toplot, AND(base_cut(), has_cand(), sim_pt(5), cand_3_st()), "COLZ")
    draw_2D(p, "absEtaVsRelPt_3st_pt10", title, binning, toplot, AND(base_cut(), has_cand(), sim_pt(10), cand_3_st()), "COLZ")
    draw_2D(p, "absEtaVsRelPt_3st_pt15", title, binning, toplot, AND(base_cut(), has_cand(), sim_pt(15), cand_3_st()), "COLZ")
    """
    ...
    draw_2D(p, "absEtaVsRelPt_2seg1rh_GE21_noCSCst2", title, binning, toplot, AND(base_cut(), has_cand(), cand_3_st_2_segments_1_rechit_GE21_no_ME21_endcap()), "COLZ")
    """
    ...
    draw_2DProfX(p, "absEtaVsRelPt_3seg_ProfX", title, binning, toplot, AND(base_cut(), has_cand(), cand_3_st_3_segments()))
    draw_2DProfX(p, "absEtaVsRelPt_2seg1rh_ProfX", title, binning, toplot, AND(base_cut(), has_cand(), cand_3_st_2_segments_1_rechit()))
    draw_2DProfX(p, "absEtaVsRelPt_2seg1rh_gem_ProfX", title, binning, toplot, AND(base_cut(), has_cand(), cand_3_st_2_segments_1_rechit_gem_endcap()))
    draw_2DProfX(p, "absEtaVsRelPt_2seg1rh_GE21_ProfX", title, binning, toplot, AND(base_cut(), has_cand(), cand_3_st_2_segments_1_rechit_GE21_endcap()))
    draw_2DProfX(p, "absEtaVsRelPt_2seg1rh_GE21_noCSCst2_ProfX", title, binning, toplot, AND(base_cut(), has_cand(), cand_3_st_2_segments_1_rechit_GE21_no_ME21_endcap()))
