...
#        base.GetXaxis().SetLimits(0,maxbin)
	...
	## simhits
    makeEffPlot(eff_sim_pt_dtsh_barrel(1), "eff_sim_pt_1dtsh_barrel", "1 DT Station with SimHits")
    makeEffPlot(eff_sim_pt_dtsh_barrel(2), "eff_sim_pt_2dtsh_barrel", "2 DT Station with SimHits")
    makeEffPlot(eff_sim_pt_dtsh_barrel(3), "eff_sim_pt_3dtsh_barrel", "3 DT Station with SimHits")
    makeEffPlot(eff_sim_pt_dtsh_barrel(4), "eff_sim_pt_4dtsh_barrel", "4 DT Station with SimHits")

    makeEffPlot(eff_sim_pt_dtsh_dtseg_barrel(1,1), "eff_sim_pt_1dtsh_1dtseg_barrel", "1 DT Station with Segments")
    makeEffPlot(eff_sim_pt_dtsh_dtseg_barrel(2,2), "eff_sim_pt_2dtsh_2dtseg_barrel", "2 DT Station with Segments")
    makeEffPlot(eff_sim_pt_dtsh_dtseg_barrel(3,3), "eff_sim_pt_3dtsh_3dtseg_barrel", "3 DT Station with Segments")
    makeEffPlot(eff_sim_pt_dtsh_dtseg_barrel(4,4), "eff_sim_pt_4dtsh_4dtseg_barrel", "4 DT Station with Segments")

	## tracks
    for n in range(2,5):
		makeEffPlot(eff_sim_pt_dtseg_recoTrackExtra(n), "eff_sim_pt_%ddtseg_recoTrackExtra"%(n), "L2 TrackExtra with %d segments"%(n))
		makeEffPlot(eff_sim_pt_dtseg_recoTrack(n), "eff_sim_pt_%ddtseg_recoTrack"%(n), "L2 Track with %d segments"%(n))
		makeEffPlot(eff_sim_pt_dtseg_recoChargedCandidate(n), "eff_sim_pt_%ddtseg_recoChargedCandidate"%(n), "L2 ChargedCandidate with %d segments"%(n))
		makeEffPlot(eff_sim_pt_dtseg_recoTrackExtra_barrel(n), "eff_sim_pt_%ddtseg_recoTrackExtra_barrel"%(n), "L2 TrackExtra with %d segments (barrel)"%(n))
		makeEffPlot(eff_sim_pt_dtseg_recoTrack_barrel(n), "eff_sim_pt_%ddtseg_recoTrack_barrel"%(n), "L2 Track with %d segments (barrel)"%(n))
		makeEffPlot(eff_sim_pt_dtseg_recoChargedCandidate_barrel(n), "eff_sim_pt_%ddtseg_recoChargedCandidate_barrel"%(n), "L2 ChargedCandidate with %d segments (barrel)"%(n))
