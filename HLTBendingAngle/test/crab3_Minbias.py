...
config.General.requestName='crab_MinbiasOnly_20160216_EffAna'
...
#config.JobType.psetName = 'runDisplacedMuonTriggerRateGENSIM_cfg.py'
...
config.Data.outputDatasetTag='crab_MinbiasOnly_20160216_EffAna'
