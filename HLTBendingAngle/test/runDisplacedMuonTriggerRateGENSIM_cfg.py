...
process = cms.Process("TriggerRate")
...
process.load("MuJetAnalysis.HLTBendingAngle.DisplacedMuonTriggerRateGENSIM_cfi")
...
process.p = cms.Path(process.DisplacedMuonTriggerRateGENSIM)
