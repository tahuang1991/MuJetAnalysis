void DarkSusy_mH_125_mGammaD_2000_cT_10_LHE_gammaD_L_XY()
{
...
//=========  (Sun May 24 15:17:52 2015) by ROOT version6.02/05
   ...
   cnv->Range(-10.625,-0.01494982,51.875,0.1000488);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   TH1F *h_gammaD_cT_XY_lab_dummy55 = new TH1F("h_gammaD_cT_XY_lab_dummy55","h_gammaD_cT_XY_lab_dummy",5,0,50);
   h_gammaD_cT_XY_lab_dummy55->SetMaximum(0.09199892);
   ...
   h_gammaD_cT_XY_lab_dummy55->GetYaxis()->SetTitle("Normalized Fraction of Events / 10.0 mm");
   ...
   TH1F *h_gammaD_cT_XY_lab56 = new TH1F("h_gammaD_cT_XY_lab56","h_gammaD_cT_XY_lab",5,0,50);
   h_gammaD_cT_XY_lab56->SetBinContent(1,0.05111051);
   h_gammaD_cT_XY_lab56->SetBinContent(2,0.02522171);
   h_gammaD_cT_XY_lab56->SetBinContent(3,0.01310773);
   h_gammaD_cT_XY_lab56->SetBinContent(4,0.00686052);
   h_gammaD_cT_XY_lab56->SetBinContent(5,0.003699525);
   h_gammaD_cT_XY_lab56->SetBinContent(6,0.004949755);
