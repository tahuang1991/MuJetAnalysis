void DarkSusy_mH_125_mGammaD_2000_cT_10_LHE_gammaD_Sorted_cT()
{
...
//=========  (Sun May 24 15:17:52 2015) by ROOT version6.02/05
   ...
   cnv->Range(-10.625,-0.0185831,51.875,0.1243638);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   TH1F *h_gammaD_1_cT_dummy59 = new TH1F("h_gammaD_1_cT_dummy59","h_gammaD_1_cT_dummy",5,0,50);
   h_gammaD_1_cT_dummy59->SetMaximum(0.1143575);
   ...
   h_gammaD_1_cT_dummy59->GetYaxis()->SetTitle("Normalized Fraction of events / 10.0 mm");
   ...
   TH1F *h_gammaD_1_cT60 = new TH1F("h_gammaD_1_cT60","h_gammaD_1_cT",5,0,50);
   h_gammaD_1_cT60->SetBinContent(1,0.06370444);
   h_gammaD_1_cT60->SetBinContent(2,0.02331731);
   h_gammaD_1_cT60->SetBinContent(3,0.00861609);
   h_gammaD_1_cT60->SetBinContent(4,0.003147654);
   h_gammaD_1_cT60->SetBinContent(5,0.001214509);
   h_gammaD_1_cT60->SetBinContent(6,0.0006833971);
   ...
   TH1F *h_gammaD_2_cT61 = new TH1F("h_gammaD_2_cT61","h_gammaD_2_cT",5,0,50);
   h_gammaD_2_cT61->SetBinContent(1,0.06353196);
   h_gammaD_2_cT61->SetBinContent(2,0.02337934);
   h_gammaD_2_cT61->SetBinContent(3,0.008709012);
   h_gammaD_2_cT61->SetBinContent(4,0.003216139);
   h_gammaD_2_cT61->SetBinContent(5,0.001163552);
   h_gammaD_2_cT61->SetBinContent(6,0.000739183);
