void DarkSusy_mH_125_mGammaD_2000_cT_10_LHE_gammaD_Sorted_cT_lab()
{
...
//=========  (Sun May 24 15:17:52 2015) by ROOT version6.02/05
   ...
   cnv->Range(-10.625,-0.0125221,51.875,0.08380178);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   TH1F *h_gammaD_1_cT_lab_dummy62 = new TH1F("h_gammaD_1_cT_lab_dummy62","h_gammaD_1_cT_lab_dummy",5,0,50);
   h_gammaD_1_cT_lab_dummy62->SetMaximum(0.07705911);
   ...
   h_gammaD_1_cT_lab_dummy62->GetYaxis()->SetTitle("Normalized Fraction of events / 10.0 mm");
   ...
   TH1F *h_gammaD_1_cT_lab63 = new TH1F("h_gammaD_1_cT_lab63","h_gammaD_1_cT_lab",5,0,50);
   h_gammaD_1_cT_lab63->SetBinContent(1,0.03763613);
   h_gammaD_1_cT_lab63->SetBinContent(2,0.02474183);
   h_gammaD_1_cT_lab63->SetBinContent(3,0.01684524);
   h_gammaD_1_cT_lab63->SetBinContent(4,0.01207486);
   h_gammaD_1_cT_lab63->SetBinContent(5,0.008701934);
   h_gammaD_1_cT_lab63->SetBinContent(6,0.04097734);
   ...
   TH1F *h_gammaD_2_cT_lab64 = new TH1F("h_gammaD_2_cT_lab64","h_gammaD_2_cT_lab",5,0,50);
   h_gammaD_2_cT_lab64->SetBinContent(1,0.04281062);
   h_gammaD_2_cT_lab64->SetBinContent(2,0.02477669);
   h_gammaD_2_cT_lab64->SetBinContent(3,0.01549773);
   h_gammaD_2_cT_lab64->SetBinContent(4,0.01022863);
   h_gammaD_2_cT_lab64->SetBinContent(5,0.006686337);
   h_gammaD_2_cT_lab64->SetBinContent(6,0.02898488);
