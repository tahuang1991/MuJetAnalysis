void DarkSusy_mH_125_mGammaD_2000_cT_100_LHE_gammaD_L_XY()
{
...
//=========  (Sun May 24 15:18:24 2015) by ROOT version6.02/05
   ...
   cnv->Range(-106.25,-0.001489937,518.75,0.009971117);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   TH1F *h_gammaD_cT_XY_lab_dummy55 = new TH1F("h_gammaD_cT_XY_lab_dummy55","h_gammaD_cT_XY_lab_dummy",5,0,500);
   h_gammaD_cT_XY_lab_dummy55->SetMaximum(0.009168843);
   ...
   h_gammaD_cT_XY_lab_dummy55->GetYaxis()->SetTitle("Normalized Fraction of Events / 100.0 mm");
   ...
   TH1F *h_gammaD_cT_XY_lab56 = new TH1F("h_gammaD_cT_XY_lab56","h_gammaD_cT_XY_lab",5,0,500);
   h_gammaD_cT_XY_lab56->SetBinContent(1,0.005093802);
   h_gammaD_cT_XY_lab56->SetBinContent(2,0.002543001);
   h_gammaD_cT_XY_lab56->SetBinContent(3,0.00130811);
   h_gammaD_cT_XY_lab56->SetBinContent(4,0.0006903695);
   h_gammaD_cT_XY_lab56->SetBinContent(5,0.0003647185);
   h_gammaD_cT_XY_lab56->SetBinContent(6,0.0004878209);
