void DarkSusy_mH_125_mGammaD_2000_cT_100_LHE_gammaD_L_Z()
{
...
//=========  (Sun May 24 15:18:24 2015) by ROOT version6.02/05
   ...
   cnv->Range(-106.25,-0.001313802,518.75,0.008792369);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   TH1F *h_gammaD_cT_Z_lab_dummy57 = new TH1F("h_gammaD_cT_Z_lab_dummy57","h_gammaD_cT_Z_lab_dummy",5,0,500);
   h_gammaD_cT_Z_lab_dummy57->SetMaximum(0.008084937);
   ...
   h_gammaD_cT_Z_lab_dummy57->GetYaxis()->SetTitle("Normalized Fraction of events / 100.0 mm");
   ...
   TH1F *h_gammaD_cT_Z_lab58 = new TH1F("h_gammaD_cT_Z_lab58","h_gammaD_cT_Z_lab",5,0,500);
   h_gammaD_cT_Z_lab58->SetBinContent(1,0.004491632);
   h_gammaD_cT_Z_lab58->SetBinContent(2,0.002458241);
   h_gammaD_cT_Z_lab58->SetBinContent(3,0.001457409);
   h_gammaD_cT_Z_lab58->SetBinContent(4,0.000933789);
   h_gammaD_cT_Z_lab58->SetBinContent(5,0.0006589293);
   h_gammaD_cT_Z_lab58->SetBinContent(6,0.003049556);
