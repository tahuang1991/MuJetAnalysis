void DarkSusy_mH_125_mGammaD_2000_cT_100_LHE_gammaD_Sorted_cT_XY_lab()
{
...
//=========  (Sun May 24 15:18:25 2015) by ROOT version6.02/05
   ...
   cnv->Range(-106.25,-0.001610696,518.75,0.01077927);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   TH1F *h_gammaD_1_cT_XY_lab_dummy65 = new TH1F("h_gammaD_1_cT_XY_lab_dummy65","h_gammaD_1_cT_XY_lab_dummy",5,0,500);
   h_gammaD_1_cT_XY_lab_dummy65->SetMaximum(0.009911976);
   ...
   h_gammaD_1_cT_XY_lab_dummy65->GetYaxis()->SetTitle("Normalized Fraction of events / 100.0 mm");
   ...
   TH1F *h_gammaD_1_cT_XY_lab66 = new TH1F("h_gammaD_1_cT_XY_lab66","h_gammaD_1_cT_XY_lab",5,0,500);
   h_gammaD_1_cT_XY_lab66->SetBinContent(1,0.004665197);
   h_gammaD_1_cT_XY_lab66->SetBinContent(2,0.00258811);
   h_gammaD_1_cT_XY_lab66->SetBinContent(3,0.001453173);
   h_gammaD_1_cT_XY_lab66->SetBinContent(4,0.0008272545);
   h_gammaD_1_cT_XY_lab66->SetBinContent(5,0.0004662659);
   h_gammaD_1_cT_XY_lab66->SetBinContent(6,0.0006879091);
   ...
   TH1F *h_gammaD_2_cT_XY_lab67 = new TH1F("h_gammaD_2_cT_XY_lab67","h_gammaD_2_cT_XY_lab",5,0,500);
   h_gammaD_2_cT_XY_lab67->SetBinContent(1,0.005506653);
   h_gammaD_2_cT_XY_lab67->SetBinContent(2,0.00249955);
   h_gammaD_2_cT_XY_lab67->SetBinContent(3,0.001168378);
   h_gammaD_2_cT_XY_lab67->SetBinContent(4,0.0005585154);
   h_gammaD_2_cT_XY_lab67->SetBinContent(5,0.0002669035);
   h_gammaD_2_cT_XY_lab67->SetBinContent(6,0.0002950866);
