void DarkSusy_mH_125_mGammaD_2000_cT_100_LHE_gammaD_Sorted_cT_lab()
{
...
//=========  (Sun May 24 15:18:25 2015) by ROOT version6.02/05
   ...
   cnv->Range(-106.25,-0.001252762,518.75,0.008383869);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   TH1F *h_gammaD_1_cT_lab_dummy62 = new TH1F("h_gammaD_1_cT_lab_dummy62","h_gammaD_1_cT_lab_dummy",5,0,500);
   h_gammaD_1_cT_lab_dummy62->SetMaximum(0.007709305);
   ...
   h_gammaD_1_cT_lab_dummy62->GetYaxis()->SetTitle("Normalized Fraction of events / 100.0 mm");
   ...
   TH1F *h_gammaD_1_cT_lab63 = new TH1F("h_gammaD_1_cT_lab63","h_gammaD_1_cT_lab",5,0,500);
   h_gammaD_1_cT_lab63->SetBinContent(1,0.003727396);
   h_gammaD_1_cT_lab63->SetBinContent(2,0.002495026);
   h_gammaD_1_cT_lab63->SetBinContent(3,0.001699681);
   h_gammaD_1_cT_lab63->SetBinContent(4,0.001210008);
   h_gammaD_1_cT_lab63->SetBinContent(5,0.0008678886);
   h_gammaD_1_cT_lab63->SetBinContent(6,0.004086067);
   ...
   TH1F *h_gammaD_2_cT_lab64 = new TH1F("h_gammaD_2_cT_lab64","h_gammaD_2_cT_lab",5,0,500);
   h_gammaD_2_cT_lab64->SetBinContent(1,0.004282947);
   h_gammaD_2_cT_lab64->SetBinContent(2,0.002492736);
   h_gammaD_2_cT_lab64->SetBinContent(3,0.00153419);
   h_gammaD_2_cT_lab64->SetBinContent(4,0.001004068);
   h_gammaD_2_cT_lab64->SetBinContent(5,0.0006860593);
   h_gammaD_2_cT_lab64->SetBinContent(6,0.002913896);
