void DarkSusy_mH_125_mGammaD_2000_cT_1000_LHE_gammaD_L_Z()
{
...
//=========  (Sun May 24 15:19:01 2015) by ROOT version6.02/05
   ...
   cnv->Range(-1062.5,-0.0001317476,5187.5,0.0008816957);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   TH1F *h_gammaD_cT_Z_lab_dummy57 = new TH1F("h_gammaD_cT_Z_lab_dummy57","h_gammaD_cT_Z_lab_dummy",5,0,5000);
   h_gammaD_cT_Z_lab_dummy57->SetMaximum(0.0008107547);
   ...
   h_gammaD_cT_Z_lab_dummy57->GetYaxis()->SetTitle("Normalized Fraction of events / 1000.0 mm");
   ...
   TH1F *h_gammaD_cT_Z_lab58 = new TH1F("h_gammaD_cT_Z_lab58","h_gammaD_cT_Z_lab",5,0,5000);
   h_gammaD_cT_Z_lab58->SetBinContent(1,0.0004504193);
   h_gammaD_cT_Z_lab58->SetBinContent(2,0.0002437274);
   h_gammaD_cT_Z_lab58->SetBinContent(3,0.0001455865);
   h_gammaD_cT_Z_lab58->SetBinContent(4,9.599354e-05);
   h_gammaD_cT_Z_lab58->SetBinContent(5,6.427329e-05);
   h_gammaD_cT_Z_lab58->SetBinContent(6,0.0003063514);
