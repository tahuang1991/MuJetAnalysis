void DarkSusy_mH_125_mGammaD_2000_cT_1000_LHE_gammaD_Sorted_cT()
{
...
//=========  (Sun May 24 15:19:01 2015) by ROOT version6.02/05
   ...
   cnv->Range(-1062.5,-0.0001860198,5187.5,0.001244902);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   TH1F *h_gammaD_1_cT_dummy59 = new TH1F("h_gammaD_1_cT_dummy59","h_gammaD_1_cT_dummy",5,0,5000);
   h_gammaD_1_cT_dummy59->SetMaximum(0.001144738);
   ...
   h_gammaD_1_cT_dummy59->GetYaxis()->SetTitle("Normalized Fraction of events / 1000.0 mm");
   ...
   TH1F *h_gammaD_1_cT60 = new TH1F("h_gammaD_1_cT60","h_gammaD_1_cT",5,0,5000);
   h_gammaD_1_cT60->SetBinContent(1,0.0006338985);
   h_gammaD_1_cT60->SetBinContent(2,0.0002346891);
   h_gammaD_1_cT60->SetBinContent(3,8.766696e-05);
   h_gammaD_1_cT60->SetBinContent(4,3.240304e-05);
   h_gammaD_1_cT60->SetBinContent(5,1.134232e-05);
   h_gammaD_1_cT60->SetBinContent(6,7.074789e-06);
   ...
   TH1F *h_gammaD_2_cT61 = new TH1F("h_gammaD_2_cT61","h_gammaD_2_cT",5,0,5000);
   h_gammaD_2_cT61->SetBinContent(1,0.0006359653);
   h_gammaD_2_cT61->SetBinContent(2,0.0002337165);
   h_gammaD_2_cT61->SetBinContent(3,8.74328e-05);
   h_gammaD_2_cT61->SetBinContent(4,3.045794e-05);
   h_gammaD_2_cT61->SetBinContent(5,1.242744e-05);
   h_gammaD_2_cT61->SetBinContent(6,7.277672e-06);
