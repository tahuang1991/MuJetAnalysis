void DarkSusy_mH_125_mGammaD_2000_cT_1000_LHE_gammaD_Sorted_cT_XY_lab()
{
...
//=========  (Sun May 24 15:19:01 2015) by ROOT version6.02/05
   ...
   cnv->Range(-1062.5,-0.0001607645,5187.5,0.001075886);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   TH1F *h_gammaD_1_cT_XY_lab_dummy65 = new TH1F("h_gammaD_1_cT_XY_lab_dummy65","h_gammaD_1_cT_XY_lab_dummy",5,0,5000);
   h_gammaD_1_cT_XY_lab_dummy65->SetMaximum(0.0009893202);
   ...
   h_gammaD_1_cT_XY_lab_dummy65->GetYaxis()->SetTitle("Normalized Fraction of events / 1000.0 mm");
   ...
   TH1F *h_gammaD_1_cT_XY_lab66 = new TH1F("h_gammaD_1_cT_XY_lab66","h_gammaD_1_cT_XY_lab",5,0,5000);
   h_gammaD_1_cT_XY_lab66->SetBinContent(1,0.0004674274);
   h_gammaD_1_cT_XY_lab66->SetBinContent(2,0.000255217);
   h_gammaD_1_cT_XY_lab66->SetBinContent(3,0.0001453261);
   h_gammaD_1_cT_XY_lab66->SetBinContent(4,8.393975e-05);
   h_gammaD_1_cT_XY_lab66->SetBinContent(5,4.808979e-05);
   h_gammaD_1_cT_XY_lab66->SetBinContent(6,7.013484e-05);
   ...
   TH1F *h_gammaD_2_cT_XY_lab67 = new TH1F("h_gammaD_2_cT_XY_lab67","h_gammaD_2_cT_XY_lab",5,0,5000);
   h_gammaD_2_cT_XY_lab67->SetBinContent(1,0.0005496223);
   h_gammaD_2_cT_XY_lab67->SetBinContent(2,0.0002509361);
   h_gammaD_2_cT_XY_lab67->SetBinContent(3,0.0001172073);
   h_gammaD_2_cT_XY_lab67->SetBinContent(4,5.56635e-05);
   h_gammaD_2_cT_XY_lab67->SetBinContent(5,2.657076e-05);
   h_gammaD_2_cT_XY_lab67->SetBinContent(6,2.936295e-05);
