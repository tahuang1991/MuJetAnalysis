void DarkSusy_mH_125_mGammaD_2000_cT_1000_LHE_gammaD_Sorted_cT_Z_lab()
{
...
//=========  (Sun May 24 15:19:01 2015) by ROOT version6.02/05
   ...
   cnv->Range(-1062.5,-0.0001351202,5187.5,0.0009042661);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   TH1F *h_gammaD_1_cT_Z_lab_dummy68 = new TH1F("h_gammaD_1_cT_Z_lab_dummy68","h_gammaD_1_cT_Z_lab_dummy",5,0,5000);
   h_gammaD_1_cT_Z_lab_dummy68->SetMaximum(0.000831509);
   ...
   h_gammaD_1_cT_Z_lab_dummy68->GetYaxis()->SetTitle("Normalized Fraction of events / 1000.0 mm");
   ...
   TH1F *h_gammaD_1_cT_Z_lab69 = new TH1F("h_gammaD_1_cT_Z_lab69","h_gammaD_1_cT_Z_lab",5,0,5000);
   h_gammaD_1_cT_Z_lab69->SetBinContent(1,0.0004381765);
   h_gammaD_1_cT_Z_lab69->SetBinContent(2,0.0002438766);
   h_gammaD_1_cT_Z_lab69->SetBinContent(3,0.0001484774);
   h_gammaD_1_cT_Z_lab69->SetBinContent(4,0.0001000791);
   h_gammaD_1_cT_Z_lab69->SetBinContent(5,6.939044e-05);
   h_gammaD_1_cT_Z_lab69->SetBinContent(6,0.0003467165);
   ...
   TH1F *h_gammaD_2_cT_Z_lab70 = new TH1F("h_gammaD_2_cT_Z_lab70","h_gammaD_2_cT_Z_lab",5,0,5000);
   h_gammaD_2_cT_Z_lab70->SetBinContent(1,0.0004619494);
   h_gammaD_2_cT_Z_lab70->SetBinContent(2,0.0002435869);
   h_gammaD_2_cT_Z_lab70->SetBinContent(3,0.0001428639);
   h_gammaD_2_cT_Z_lab70->SetBinContent(4,9.214573e-05);
   h_gammaD_2_cT_Z_lab70->SetBinContent(5,5.945397e-05);
   h_gammaD_2_cT_Z_lab70->SetBinContent(6,0.0002683356);
