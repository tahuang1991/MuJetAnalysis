void DarkSusy_mH_125_mGammaD_2000_cT_0_LHE_gammaD_L_XY()
{
...
//=========  (Sun May 24 15:19:45 2015) by ROOT version6.02/05
   ...
   TH1F *h_gammaD_cT_XY_lab_dummy55 = new TH1F("h_gammaD_cT_XY_lab_dummy55","h_gammaD_cT_XY_lab_dummy",10,0,10);
   h_gammaD_cT_XY_lab_dummy55->SetMaximum(1.8);
   ...
   h_gammaD_cT_XY_lab_dummy55->GetYaxis()->SetTitle("Normalized Fraction of Events / 1 mm");
   ...
   TH1F *h_gammaD_cT_XY_lab56 = new TH1F("h_gammaD_cT_XY_lab56","h_gammaD_cT_XY_lab",10,0,10);
   h_gammaD_cT_XY_lab56->SetBinContent(1,1);
