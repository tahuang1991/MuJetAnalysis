void DarkSusy_mH_125_mGammaD_2000_cT_0_LHE_gammaD_L_Z()
{
...
//=========  (Sun May 24 15:19:45 2015) by ROOT version6.02/05
   ...
   TH1F *h_gammaD_cT_Z_lab_dummy57 = new TH1F("h_gammaD_cT_Z_lab_dummy57","h_gammaD_cT_Z_lab_dummy",10,0,10);
   h_gammaD_cT_Z_lab_dummy57->SetMaximum(1.8);
   ...
   h_gammaD_cT_Z_lab_dummy57->GetYaxis()->SetTitle("Normalized Fraction of events / 1 mm");
   ...
   TH1F *h_gammaD_cT_Z_lab58 = new TH1F("h_gammaD_cT_Z_lab58","h_gammaD_cT_Z_lab",10,0,10);
   h_gammaD_cT_Z_lab58->SetBinContent(1,1);
