void DarkSusy_mH_125_mGammaD_2000_cT_0_LHE_gammaD_Sorted_cT()
{
...
//=========  (Sun May 24 15:19:45 2015) by ROOT version6.02/05
   ...
   TH1F *h_gammaD_1_cT_dummy59 = new TH1F("h_gammaD_1_cT_dummy59","h_gammaD_1_cT_dummy",10,0,10);
   h_gammaD_1_cT_dummy59->SetMaximum(1.8);
   ...
   h_gammaD_1_cT_dummy59->GetYaxis()->SetTitle("Normalized Fraction of events / 1 mm");
   ...
   TH1F *h_gammaD_1_cT60 = new TH1F("h_gammaD_1_cT60","h_gammaD_1_cT",10,0,10);
   h_gammaD_1_cT60->SetBinContent(1,1);
   ...
   TH1F *h_gammaD_2_cT61 = new TH1F("h_gammaD_2_cT61","h_gammaD_2_cT",10,0,10);
   h_gammaD_2_cT61->SetBinContent(1,1);
