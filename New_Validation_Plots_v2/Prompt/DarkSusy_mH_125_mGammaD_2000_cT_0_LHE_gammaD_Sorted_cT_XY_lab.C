void DarkSusy_mH_125_mGammaD_2000_cT_0_LHE_gammaD_Sorted_cT_XY_lab()
{
...
//=========  (Sun May 24 15:19:45 2015) by ROOT version6.02/05
   ...
   TH1F *h_gammaD_1_cT_XY_lab_dummy65 = new TH1F("h_gammaD_1_cT_XY_lab_dummy65","h_gammaD_1_cT_XY_lab_dummy",10,0,10);
   h_gammaD_1_cT_XY_lab_dummy65->SetMaximum(1.8);
   ...
   h_gammaD_1_cT_XY_lab_dummy65->GetYaxis()->SetTitle("Normalized Fraction of events / 1 mm");
   ...
   TH1F *h_gammaD_1_cT_XY_lab66 = new TH1F("h_gammaD_1_cT_XY_lab66","h_gammaD_1_cT_XY_lab",10,0,10);
   h_gammaD_1_cT_XY_lab66->SetBinContent(1,1);
   ...
   TH1F *h_gammaD_2_cT_XY_lab67 = new TH1F("h_gammaD_2_cT_XY_lab67","h_gammaD_2_cT_XY_lab",10,0,10);
   h_gammaD_2_cT_XY_lab67->SetBinContent(1,1);
