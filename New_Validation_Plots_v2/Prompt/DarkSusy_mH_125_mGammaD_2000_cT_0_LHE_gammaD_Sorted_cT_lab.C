void DarkSusy_mH_125_mGammaD_2000_cT_0_LHE_gammaD_Sorted_cT_lab()
{
...
//=========  (Sun May 24 15:19:45 2015) by ROOT version6.02/05
   ...
   TH1F *h_gammaD_1_cT_lab_dummy62 = new TH1F("h_gammaD_1_cT_lab_dummy62","h_gammaD_1_cT_lab_dummy",10,0,10);
   h_gammaD_1_cT_lab_dummy62->SetMaximum(1.8);
   ...
   h_gammaD_1_cT_lab_dummy62->GetYaxis()->SetTitle("Normalized Fraction of events / 1 mm");
   ...
   TH1F *h_gammaD_1_cT_lab63 = new TH1F("h_gammaD_1_cT_lab63","h_gammaD_1_cT_lab",10,0,10);
   h_gammaD_1_cT_lab63->SetBinContent(1,1);
   ...
   TH1F *h_gammaD_2_cT_lab64 = new TH1F("h_gammaD_2_cT_lab64","h_gammaD_2_cT_lab",10,0,10);
   h_gammaD_2_cT_lab64->SetBinContent(1,1);
